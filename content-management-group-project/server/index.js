...
// BUNDLE OF BUILD FOLDER sessions
app.use(session({
...
app.get("/login", passport.authenticate("auth0", {failureRedirect: "www.contentum.now.sh/#/"}), function (req, res) {
